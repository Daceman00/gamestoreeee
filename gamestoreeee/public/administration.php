...
<div class="modal" tabindex="-1" role="dialog" id="addNewProduct">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary">ADD PRODUCTS</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="games/add.php" method="POST" id="addUserForm" enctype="multipart/form-data">
                        <div class="row mb-3 gx-3">
                            <div class="form-group col ">
                                <input type="hidden" name="idKorisnika" />
                                <input type="text" name="publisher" id="publisher" class="form-control form-control-sm" placeholder="publisher" required>
                            </div>
                            <div class="form-group col">                           
                        ...
                        <div class="row mb-3 gx-3">
                            ...
                            <div class="form-group col">
                                <input type="text" name="genre" id="genre" class="form-control form-control-sm" placeholder="genre" required>
                            </div>
                        </div>
                        <div class="row mb-3 gx-3">
                            <div class="form-group col">
                                <input type="text" name="sizememory" id="sizememory" class="form-control form-control-sm" placeholder="sizememory" required>
                            </div>
                        ...
                        <div class="row mb-3 gx-3">                           
                            <div class="form-group col">
                                <div class="custom-file">
                                    <label class="custom-file-label" for="image">Select picture</label>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="deleteWarningProd">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <p class="text-primary">Are you sure you want delete game?</p>
            </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="editProduct">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary">Editing game</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="addNewUser">
        <div class="modal-dialog modal-dialog-centered" role="document" style="width:300px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary">Add User</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="deleteWarning">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <p class="text-primary">Are you sure you want delete user?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                <a href="#" id="modalDelete" class="btn btn-primary">Yes</a>
            </div>
        </div>
    </div>    
</div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="editmodal">
        <div class="modal-dialog modal-dialog-centered" role="document" style="width:300px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary">Editing user</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="row mb-1">
                            ...
                            <input type="hidden" name="update_id" id="update_id">
                                <input type="text" name="firstName" id="firstName" class="form-control form-control-sm" placeholder="Name" required>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="form-group col ">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="container">
                    <div class="card mt-5" id="pregled" style="scroll-margin-top:80px;">
                        <h5 class="card-header bg-info" style="color:white;" >System managment</h5>
                        <div class="card-body">
                            <div class="container">
                    ...
                    <div class="card mt-5" id="korisnici" style="scroll-margin-top:80px;">
                        <h5 class="card-header bg-info" style="color:white;">Users</h5>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="#" class="btn btn-success  editbtn " title="Uređivanje profila">Edit</a>
                                            <a  type="button" title="Brisanje profila" class="btn btn-danger text-white" data-toggle="modal" data-id="<?= $user["id"] ?>" data-target="#deleteWarning">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endforeach?>
                                </tbody>
                    ...
                    <div class="card mt-5" id="proizvodi" style="scroll-margin-top:80px;">
                        <h5 class="card-header bg-info" style="color:white;">Games</h5>
                        <div class="card-body" style="overflow-x:auto;">                                       
                            <table class="table">
                                <thead class="thead-light">
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center"><img src="<?=$game['image']?>" alt="" style="width:70px;height:70px;"></td>
                                        <td class="align-middle text-center"><?=$game['Name']?></td>
                                        <td class="align-middle text-center"><?=$game['Publisher']?></td>
                                        <td class="align-middle text-center"><?=$game['Genre']?></td>
                                        <td class="align-middle text-center"><?=$game['Price']?></td>
                                        <td class="align-middle text-center"><?=$game['Sizememory']?> Kn</td>
                                        <td class="align-middle">
                                            <a href="#" class="btn btn-success mb-1" title="Uređivanje profila">Edit</a>
                                            <a  type="button" class="btn btn-danger text-white delete-product" data-toggle="modal" data-id="<?= $game["ID"] ?>" data-target="#deleteWarningProd">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endforeach?>
                                </tbody>
    ...
    <script>
        $(document).ready(function(){
            $('#deleteWarningProd').on('show.bs.modal', function(e) {
                ...
                $('#modalDelete').attr('href', 'games/delete.php?id=' + id);
            });
